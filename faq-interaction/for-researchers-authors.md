---
description: >-
  FAQ for authors of research that The Unjournal selected for public evaluation,
  and for authors considering submitting their work to The Unjournal for
  evaluation
---
...
You can also share [feedback on your experience with The Unjournal](https://info.unjournal.org/feedback.html). The form asks for no name or email; you can opt in to a de-identified summary for team and public updates.
...
3. We may ask for a link to data and code, if possible. Note that our project is not _principally_ about replication, and we are not insisting on this. However, sharing code, data, and materials is [highly encouraged](#user-content-fn-6)[^6].
...
As you can see in our [evaluation workflow](../policies-projects-evaluation-workflow/mapping-evaluation-workflow/), on this track, we engage with authors especially at two points:&#x20;
