...
{% hint style="info" %}
This comparison is auto-generated from our internal database. Last updated: September 2026
{% endhint %}
...
| [PubPub](https://www.pubpub.org/) | 🔧 Platform/tool: reviewing/rating/endorsing (and publishing) | We use PubPub to host our evaluations at Unjournal.pubpub.org. It has many strong features and we continue to collaborate with Knowledge Futures on development. |
| [eLife (hosted within Sciety)](https://elifesciences.org/about/) | 📄 Open public evaluation initiative or innovative journal |  |
...
| [Plaudit - endorse a preprint](https://plaudit.pub) | 🔧 Platform/tool: reviewing/rating/endorsing (and publishing) | Plaudit is a third-party tool. OSF seems to encourage it (https://help.osf.io/hc/en-us/articles/360038856834-Endorse-a-Preprint). |
| [ResearchHub](https://www.researchhub.com/) | 🔧 Platform/tool: reviewing/rating/endorsing (and publishing) | Hub to upload/link DOI'd research, by subject. Comments and 'costly' upvotes/downvotes (?), no explicit 'reviewing' process. For-profit? "..." |
| [Scipost](https://scipost.org/about) | 📄 Open public evaluation initiative or innovative journal | Making good inroads in physics+ |
| [Alethia](https://aletheia-platform.netlify.app/) | 📄 Open public evaluation initiative or innovative journal | Has most of Unjournal's features, but no quantitative measures, no external funding for evaluators, and seems very small. |
| [In&vertebrates](https://inandsight.science/) | 📄 Open public evaluation initiative or innovative journal |  |
| [Nature Human Behavior](https://www.nature.com/nathumbehav/editorial-policies/peer-review) | 📄 Open public evaluation initiative or innovative journal | Optional transparent peer review (author opt-in, for accepted work) |
| [ReviewCommons](https://www.reviewcommons.org/) | 🔧 Platform/tool: reviewing/rating/endorsing (and publishing) | Review Commons is a platform for high-quality journal-independent peer-review in the life sciences." Pre-prints reviewed, |
| Science Open | 🔧 Platform/tool: reviewing/rating/endorsing (and publishing) | Working with traditional and open journals and trying to bring in stakeholders. Seems to foster academic editor-based curation. |
| [SqARE](https://sqare.org/faq/) | 📄 Open public evaluation initiative or innovative journal | Nascent? Econometrics focused |
| [Stanford Program on Research Rigor & Reproducibility (SPORR)](https://med.stanford.edu/sporr) |  | Focus on medicine? |
