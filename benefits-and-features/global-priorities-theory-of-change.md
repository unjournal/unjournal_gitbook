...
Some of the paths will take longer than others; in particular, it will be hard to get academia to change, particularly because of entrenched systems and a collective action problem. We discuss how we hope to overcome this [in our introduction](../../readme-1/#change-is-hard-overcoming-academic-inertia). In particular, we can provide leadership and take risks that academics won't take themselves:
