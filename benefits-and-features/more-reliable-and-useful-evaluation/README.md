# More reliable and useful evaluation
...
See our [Broken link](broken-reference "mention")  and [Broken link](broken-reference "mention") (these are our pilot metrics, we aim to refine these).
...
1. _Early evaluation:_ We will evaluate potentially-impactful research soon after it is released (as a working paper, preprint, etc.) We will [encourage authors](#user-content-fn-3)[^3] to submit their work for our evaluation, and we will [directly commission](#user-content-fn-4)[^4] the evaluation of work from the highest-prestige authors.
...
[^2]: At least, this is our main approach as of June 2023.

[^3]: See [Broken link](broken-reference "mention")

[^4]: See [Broken link](broken-reference "mention")
