# The Unjournal Evaluator Prize 2024–25: Celebrating Outstanding Public Peer Review

*Celebrating outstanding public peer review: rigorous, constructive, and decision-relevant evaluation of research that matters.*
...
> **Our commitment:** For the 2024–25 cycle, The Unjournal set aside $75 per evaluation toward prize incentives, building a pool of $6,500 in evaluator prizes. Combined with base compensation ($300+ per evaluation) and promptness bonuses, our average evaluator compensation target is approximately $450 per evaluation.
...
- [Read the Full Evaluation](https://unjournal.pubpub.org/pub/e1watertreatment)
- [Evaluation Summary](https://unjournal.pubpub.org/pub/evalsumwatertreatment)
- [Authors' Response](https://unjournal.pubpub.org/pub/bgh98s2i)
...
- [Evaluation Summary](https://unjournal.pubpub.org/pub/evalsumnaturalregeneration/release/3)

> "Annual investment in forests must more than triple from US$84 billion in 2023 to US$300 billion by 2030."
> — [UN Environment Programme, *State of Finance for Forests 2025*](https://www.unep.org/resources/report/state-finance-forests-2025)
...
Five additional evaluations received commendations for their quality, rigor, and usefulness. Two of these will be selected by [transparent random draw](lottery.html) to receive **500 USD prizes**.
...
["Universal Basic Income: Short-Term Results from a Long-Term Experiment in Kenya"](https://unjournal.pubpub.org/pub/eval2universalincome/release/3)
...
### 4. Anonymous evaluator
["The Macroeconomic Impact of Climate Change: Global vs. Local Temperature"](https://unjournal.pubpub.org/pub/e2macroclimatechange/release/1)
...
### 5. Anonymous evaluator
["The Wellbeing Cost-effectiveness of StrongMinds and Friendship Bench"](https://unjournal.pubpub.org/pub/e2strongminds/release/2)
Topics: Global Health, Wellbeing
...
[Go to the Lottery Draw Page →](lottery.html)
...
- **Depth & Rigor** — How deeply did the evaluation engage with the paper's methods, assumptions, and evidence? Did it go beyond surface-level review to provide technical substance?
- **Constructive Insight** — Did the evaluation offer specific, actionable suggestions? Did it identify ways to strengthen the work rather than simply cataloging weaknesses?
- **Real-World Relevance** — Did the evaluation consider the paper's implications for policy, practice, or global priorities? Did it help readers assess how much to rely on the findings?
- **Communication** — Was the evaluation clearly written and accessible? Could it be useful to researchers, practitioners, and policymakers—not just narrow specialists?
- **Follow-through** — Did the evaluator engage in iterative dialogue—responding to manager queries, collaborating with co-evaluators, or providing additional analysis when needed?
- **Expertise** — Did the evaluation demonstrate genuine subject-matter expertise and the ability to assess claims critically within the relevant field?

These criteria align with The Unjournal's [evaluator guidelines](https://globalimpact.gitbook.io/the-unjournal-project-and-communication-space/policies-projects-evaluation-workflow/evaluation/guidelines-for-evaluators), which ask evaluators to provide substantive evaluation (resembling a high-quality journal referee report, without the binary accept/reject focus), quantitative ratings across nine dimensions with uncertainty ranges, and considered assessments of each paper's main claims.

---

**Learn more:**
[unjournal.org](https://unjournal.org) | [Published evaluations](https://unjournal.pubpub.org/) | [Interactive dashboard](https://unjournal.shinyapps.io/uj-dashboard/) | [Documentation & policies](https://globalimpact.gitbook.io/the-unjournal-project-and-communication-space/)
...
- [Become an Evaluator](https://coda.io/form/Join-the-Unjournal_dc3NLlpa-eq)
- [Submit Research](https://bit.ly/UJsubmit)
- [Follow Us](https://info.unjournal.org/follow)
