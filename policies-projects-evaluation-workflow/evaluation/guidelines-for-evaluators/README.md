...
[**60-74.9**](#user-content-fn-11)[^11]**:** A very strong, solid, and relevant piece of work. It may have minor flaws or limitations, but overall it is very high-quality, meeting the standards of well-respected research professionals in this field.
...
[_Note that all of these criteria are scales (not binaries_](#user-content-fn-12)[^12]_)._
...
Do the insights generated inform our (‘posterior’) beliefs about important parameters and about the effectiveness of interventions? [Note that we do not require a substantial _shift_ in our expectations; sound and well-presented 'null results' can be valuable.](#user-content-fn-13)[^13]
...
Are the results/methods likely to be robust to reasonable changes in the underlying assumptions? [Does the author demonstrate this?](#user-content-fn-14)[^14]
...
[Does the paper consider the real-world relevance of the arguments and results presented, perhaps engaging policy and implementation questions?](#user-content-fn-15)[^15]
...
_Suggested weighting: 0._ [_Why 0?_](#user-content-fn-16)[^16]
...
3. this research was being submitted to journals according [to this fair process.\*](#user-content-fn-17)[^17]
...
_Your answers to the questions_ [_below will not be made public:_](#user-content-fn-18)[^18] &#x20;
...
[^9]: _Above, we completed both only for illustration purposes. Below, we give a suggested correspondence between these two measures._ &#x20;

[^10]: For example, you might weight categories less where you are more uncertain, or where the category seems less relevant.

[^11]: This previously read "60-75"; we adjusted this because some evaluators found the overlap unclear.

[^12]: _So, consider each of the questions below to be prefaced with "to what extent"._

[^13]: If research is conceptually and methodologically sound (including being adequately powered), carefully presented ‘null results’ can, in general, advance the field. I.e., (in Bayesian terminology) work that “substantially concentrates our belief distributions around the initial expectations” is also highly valuable.

[^14]: E.g., did they give at least a reasonable range of robustness checks? At best, did they ‘map the space’ of possible reasonable specifications?
