...
_We are considering adding the following 'additional track' for commissioning research to be evaluated by The Unjournal,_
...
_**Response:**_ We will be careful with this. Initially, we are extending this onluy to the NBER series. Next, we may consider direct evaluation of fairly prestigious publications in 'actual peer-reviewed journals' particularly in fields (such as psychology) where the peer review process is much faster than in economics. As NBER is basically "USA only", we may also consider extending this to other series such as [CEPR](https://cepr.org/publications/discussion-papers), but being careful about the prestige/vulnerability tradeoffs.&#x20;
